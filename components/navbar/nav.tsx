                            ...
                            <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                                <nav className="flex flex-col gap-4">
                                    ...
                                    <div className="balanceItems py-1 px-2">
                                        ...
                                        <Switch id="mode-toggle" aria-labelledby={'mode-toggle-label'} className={'ml-4'} checked={checkedMode}
                                    ...
                                    <div className="balanceItems py-1 px-2">
                                        ...
                                        <Switch id="mensa-toggle" aria-labelledby={'mensa-toggle-label'} className={'ml-4'} checked={checkedMensa}
                        ...
                        <nav className="mx-6 hidden sm:flex space-x-4">
                            ...
                            <div className={'hidden lg:flex items-center space-x-4'}>
                                <Label id={'mode-toggle-label'} htmlFor="mode-toggle">View Mode: <span
                                    className={`${!checkedMode ? 'font-extrabold' : ''}`}>PDF</span> | <span
                                    className={`${checkedMode ? 'font-extrabold' : ''}`}>Text</span></Label>
                                <Switch id="mode-toggle" aria-labelledby={'mode-toggle-label'} checked={checkedMode} onCheckedChange={onModeToggle}/>
                                <Label id={'mensa-toggle-label'} htmlFor="mensa-toggle">Mensa: <span
                                    className={`${!checkedMensa ? 'font-extrabold' : ''}`}>HT201</span> | <span
                                    className={`${checkedMensa ? 'font-extrabold' : ''}`}>HTP</span></Label>
                                <Switch id="mensa-toggle" aria-labelledby={'mensa-toggle-label'} checked={checkedMensa} onCheckedChange={onMensaToggle}/>
                            </div>
                        </nav>
                        <div className={'ml-auto flex items-center space-x-4'}>
                            <Button aria-label={'settings'} variant="outline" size="icon" onClick={() => router.push('/settings')}>
